...
const orderService = (() => {
    ...
    const getOrderDetail = async () => {
        try {
            const res = await fetch(`/api/mypage/purchase-detail`);
    ...
    const cancelOrder = async () => {
        try {
            const res = await fetch(`/api/mypage/purchase-detail/status?paymentPhase=REFUND`, { method: "PUT" });
    ...
    const payOrder = async () => {
        try {
            const res = await fetch(`/api/mypage/purchase-detail/status?paymentPhase=SUCCESS`, { method: "PUT" });
    ...
    const completeReceive = async () => {
        try {
            const res = await fetch(`/api/mypage/purchase-detail/status?paymentPhase=RECEIVED`, { method: "PUT" });
    ...
    const submitReview = async (sellerId, purchaseId, score) => {
        try {
            const res = await fetch(`/api/mypage/purchase-detail/rating`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    sellerId: sellerId,
