...
VALUES ('홍길동', '010-1111-2222', 'seller@test.com');
...
VALUES ('2', '010-9999-3333', '2025093022321855389', '11234', '101동 1001호', '서울시 동작구 무슨로');
...
-- 5. 결제 (payment)
INSERT INTO tbl_payment (member_id)
VALUES (2);

-- 6. 결제 상태 (payment_status)
INSERT INTO tbl_payment_status (payment_phase, purchase_id, payment_id)
VALUES ('request', 1, 1);
-- payment_id는 아직 독립 테이블 없으니 임의 숫자(dummy)

-- 7. 파일 (file)
INSERT INTO tbl_file (file_origin_name, file_path, file_name, file_size)
VALUES ('gift-shop-post-img2.jpg', '/images', 'key-ring2', '200KB');
